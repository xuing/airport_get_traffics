...
def login(email, password):
    headers = {
        "User-Angent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
...
def get_traffic(s):
    ...
    print("get_traffic status: ", res)
    try:
        print(res.json())
    except:
        print("get_traffic error, text: ", res.text)
